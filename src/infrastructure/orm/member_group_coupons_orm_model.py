from sqlalchemy import Column, Integer, DateTime, func, Boolean, ForeignKey, String, Date
from sqlalchemy.dialects.postgresql import JSONB

from domain.models.member_group_coupon import MemberGroupCoupon
from infrastructure.db.base_class import Base


class MemberGroupCouponOrmModel(Base):
    __tablename__ = "member_group_coupons"
    ...
    coupon_definition_id = Column(Integer, ForeignKey('coupon_definitions.id'))
    ...
    group_redemption_period_limit = Column(Integer)
    group_redemption_period_type = Column(String)



    @staticmethod
    def from_domain(obj_in: MemberGroupCoupon):
        orm = MemberGroupCouponOrmModel()
        orm.id=obj_in.id
        ...
        orm.member_group_id=obj_in.member_group_id
        ...
        orm.group_redemption_period_limit = obj_in.group_redemption_period_limit
        orm.group_redemption_period_type = obj_in.group_redemption_period_type
        return orm

    def to_domain(self) -> MemberGroupCoupon:
        """Convert this MemberGroupUsersOrmModel instance to a MemberGroupUsers domain model."""
        return MemberGroupCoupon(
            id=self.id,
            ...
            group_redemption_period_limit = self.group_redemption_period_limit,
            group_redemption_period_type = self.group_redemption_period_type,
        )
